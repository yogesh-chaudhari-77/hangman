...
public class dictTester {
    ...
    public static void main(String [] args) throws IOException {
        ...
        String dictionaryFilename = System.getProperty("user.dir")+"/src/words_400k.txt";

        int maxIncorrectGuesses = 3;

        Set<String> dictionary = loadDictionary(dictionaryFilename);

        FileWriter csvWriter = new FileWriter(System.getProperty("user.dir")+"/src/test/results/dictTestResults_3Guesses_400KSampleSet.csv");
        ...
        //for(String word : specialSet()) {
            ...
            boolean result = game.runGame(wordsToGuess, maxIncorrectGuesses, solver);
            {
                ...
                csvWriter.append(z + "," + word + "," + maxIncorrectGuesses + "," + result + "," + ((DictAwareSolver) solver).getKnownWords().size() + "," + guessSequence + "\n");
            }

...
public class HangmanGameTester
{
     ...
     */
    public HangmanGameTester(PrintWriter writer, HangmanGameTracer tracer)
    {
        mOutWriter = writer;
        mTracer = tracer;
    } // end of HangmanGame()
     ...
     */
    // @Override
    public boolean runGame(String[] wordsToGuess, int maxIncorrectNum, HangmanSolver solver)
     ...
     *
     * @param wordsStatus Current status of words.
     *
